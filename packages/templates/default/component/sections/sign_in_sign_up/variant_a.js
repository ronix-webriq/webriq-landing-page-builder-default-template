      ...
      <div className="flex flex-wrap">
        ...
        <div className="hidden lg:block relative w-full lg:w-1/2">
          ...
          >
            ...
            <a
              className="inline-block py-2 px-6 rounded-t-xl leading-loose rounded-l-xl bg-green-600 hover:bg-green-700 text-gray-50 font-bold transition duration-200"
              href="#"
            >
              Get Started
            </a>
        ...
        <div className="lg:hidden">
          ...
          <div className="py-10 px-3 text-center" style={{ zIndex: 10 }}>
            ...
            <a
              className="inline-block py-2 px-6 rounded-t-xl rounded-l-xl bg-green-600 hover:bg-green-700 text-gray-50 font-bold transition duration-200"
              href="#"
            >
              Get Started
            </a>
