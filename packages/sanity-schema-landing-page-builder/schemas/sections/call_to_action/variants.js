...
export const variantA = () => {
  return <img src={variant_a} className={styles.callToAction} />
}

export const variantB = () => {
  return <img src={variant_b} className={styles.callToAction} />
}

export const variantC = () => {
  return <img src={variant_c} className={styles.callToAction} />
}

export const variantD = () => {
  return <img src={variant_d} className={styles.callToAction} />
}
