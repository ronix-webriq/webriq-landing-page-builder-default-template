...
export const variantA = () => {
  return <img src={variant_a} className={styles.team} />
}

export const variantB = () => {
  return <img src={variant_b} className={styles.team} />
}

export const variantC = () => {
  return <img src={variant_c} className={styles.team} />
}

export const variantD = () => {
  return <img src={variant_d} className={styles.team} />
}
