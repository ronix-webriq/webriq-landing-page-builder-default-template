...
export const variantA = () => {
  return <img src={variant_a} className={styles.testimonial} />
}

export const variantB = () => {
  return <img src={variant_b} className={styles.testimonial} />
}

export const variantC = () => {
  return <img src={variant_c} className={styles.testimonial} />
}

export const variantD = () => {
  return <img src={variant_d} className={styles.testimonial} />
}
