...
export const variantA = () => {
  return <img src={variant_a} className={styles.portfolio} />
}

export const variantB = () => {
  return <img src={variant_b} className={styles.portfolio} />
}

export const variantC = () => {
  return <img src={variant_c} className={styles.portfolio} />
}

export const variantD = () => {
  return <img src={variant_d} className={styles.portfolio} />
}
