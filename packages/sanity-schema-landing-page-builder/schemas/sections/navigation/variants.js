...
export const variantA = () => {
  return <img src={variant_a} className={styles.navigation} />
}

export const variantB = () => {
  return <img src={variant_b} className={styles.navigation} />
}

export const variantC = () => {
  return <img src={variant_c} className={styles.navigation} />
}

export const variantD = () => {
  return <img src={variant_d} className={styles.navigation} />
}
