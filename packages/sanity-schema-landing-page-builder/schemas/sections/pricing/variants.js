...
export const variantA = () => {
  return <img src={variant_a} className={styles.pricing} />
}

export const variantB = () => {
  return <img src={variant_b} className={styles.pricing} />
}

export const variantC = () => {
  return <img src={variant_c} className={styles.pricing} />
}

export const variantD = () => {
  return <img src={variant_d} className={styles.pricing} />
}
